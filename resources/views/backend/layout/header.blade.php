...
@endphp
    <meta charset="utf-8" />
    <title> {{ ucwords($title ?? 'Dashboard' ) }}</title>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('assets/images/afos/index.ico') }}">
    <!-- third party css -->
    ...
    <link href="{{ asset('assets/css/vendor/sweetalert.min.css') }}" rel="stylesheet" type="text/css" />
