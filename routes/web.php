...
Route::prefix('backend')->middleware(['auth'])->group(function(){
    ...
    Route::prefix('reports')->middleware(['checkAccess'])->group(function(){
        Route::get('/location/wise', [App\Http\Controllers\backend\ReportController::class, 'location_wise_report'])->name('reports.location.wise');
        Route::get('/class/wise', [App\Http\Controllers\backend\ReportController::class, 'location_wise_report'])->name('reports.class.wise');
        Route::get('/food/type', [App\Http\Controllers\backend\ReportController::class, 'location_wise_report'])->name('reports.food.type');
    });
